...
public class SignUpPage extends BasePage {
    ...
    public SignUpPage(Page page) {
        super(page);
        this.signInLink = page.getByRole(AriaRole.LINK,
        ...
        this.hidePasswordButton = page.getByRole(AriaRole.BUTTON,
                new Page.GetByRoleOptions().setName("Hide password"));
        this.confirmPasswordTextField = page.getByLabel("Confirm Password");
        this.showConfirmPasswordButton = page.locator("div")
                .filter(new Locator.FilterOptions()
                        .setHasText(Pattern.compile("^Confirm Password$")))
                .getByLabel("Show password");
        this.hideConfirmPasswordButton = page.locator("div")
                .filter(new Locator.FilterOptions()
                        .setHasText(Pattern.compile("^Confirm Password$")))
                .getByLabel("Hide password");
        this.agreeCheckbox = page.getByLabel("I agree to the Privacy Policy");
        this.createAccountButton = page.getByRole(AriaRole.BUTTON,
